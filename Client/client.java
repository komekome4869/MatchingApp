...
a
	...
	public void myProfile() {
        ...
        JComboBox<String> cbGenderMyProfile;
        cbGenderMyProfile = new JComboBox<>();
        cbGenderMyProfile.addItem("男");
        cbGenderMyProfile.addItem("女");
        cbGenderMyProfile.addItem("選択しない");
        ...
        JComboBox<String> cbGradeMyProfile;
        cbGradeMyProfile = new JComboBox<>();
        ...
        JLabel lDisciplineMyProfile = new JLabel("学科");
		lDisciplineMyProfile.setBounds(w/8,34*h/60,w/6,h/30);
		lDisciplineMyProfile.setFont(new Font("ＭＳ 明朝", Font.PLAIN, w/25));
		lDisciplineMyProfile.setHorizontalAlignment(JLabel.CENTER);
        card.add(lDisciplineMyProfile);

        JComboBox<String> cbDisciplineMyProfile;
        cbDisciplineMyProfile = new JComboBox<>();
        cbDisciplineMyProfile.addItem("学校教員養成課程");
        cbDisciplineMyProfile.addItem("経営学科");
        cbDisciplineMyProfile.addItem("経済学科");
        cbDisciplineMyProfile.addItem("機械・材料・海洋系学科");
        cbDisciplineMyProfile.addItem("化学・生命系学科");
        cbDisciplineMyProfile.addItem("数物・電子情報系学科");
        cbDisciplineMyProfile.addItem("都市社会共生学科");
        cbDisciplineMyProfile.addItem("建築学科");
        cbDisciplineMyProfile.addItem("都市基盤学科");
        cbDisciplineMyProfile.addItem("環境リスク共生学科");
        cbDisciplineMyProfile.setBounds(w/3,34*h/60,w/2,h/30);
		cbDisciplineMyProfile.setFont(new Font("ＭＳ 明朝", Font.PLAIN, w/25));
        card.add(cbDisciplineMyProfile);
        ...
        JTextField tfBirthMyProfile = new JTextField("");
        tfBirthMyProfile.setBounds(w/3,37*h/60,w/2,h/30);
        tfBirthMyProfile.setFont(new Font("ＭＳ 明朝", Font.PLAIN, w/25));
        card.add(tfBirthMyProfile);
